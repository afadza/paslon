...
const AddPaslon = () => {
  const addPaslonMutation = useMutation((newPaslonData) => axios.post('http://localhost:3000/posts', newPaslonData));
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-4">
            <label htmlFor="" className="w-full font-bold">
              Nama Paslon
              <input type="text" name="namaPaslon" className="border-2 w-full rounded-lg" />
            </label>
          </div>
          <div className="mb-4">
            <label htmlFor="" className="w-full font-bold">
